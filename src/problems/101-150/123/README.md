Let p<supb>n</sub> be the nth prime: 2, 3, 5, 7, 11, ..., and let r be the remainder when (p<sub>n</sub>−1)<sup>n</sup> + (p<sub>n</sub>+1)<sup>n</sup> is divided by p<sub>n</sub><sup>2</sup>.
