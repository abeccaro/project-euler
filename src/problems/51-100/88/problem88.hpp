...
namespace problems {
    ...
    private:
         ...
         */
        static void calculate_mps_recursive(vector<uint>& mps, uint ub, vector<uint>& a, uint sum, uint product);
         ...
         */
        static vector<uint> calculate_mps(uint ub);
    public:
        /**
         * Solves problem
         ...
         * @return The solution
         */
        static uint solve(uint ub = 12000);
    };
}
